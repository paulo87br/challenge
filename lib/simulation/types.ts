...
export type WorldEvent={id:string;channel:Channel;sender:string;characterId?:string;recipientCharacterId?:string;subject?:string;body:string;urgency:number;visible:boolean;reason?:string;at:number;delay_minutes?:number};
